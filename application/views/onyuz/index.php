...
<head>
  ...
  <title>Furkan Ceker Resume</title>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
<!--           <div class="col-lg-4">
            <img src="<?= base_url('assets/front/')?>assets/img/resume.jpg" class="img-fluid m-auto d-block"  alt="">
          </div> -->
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Facts</h2>
          <p>proje sayısı, memnun müşteri vs.</p>
        </div>
...
<!--                 <div class="portfolio-links">
                  <a href="<?= base_url('assets/front/')?>assets/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>MySelf</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="https://www.linkedin.com/in/furkanceker/">Furkan</a>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="<?= base_url('assets/front/')?>assets/vendor/typed.js/typed.min.js"></script>
